...
export type NAMESPACE_APP_INTERACTIONS_TYPES__ENTITYGetResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<NAMESPACE_TYPES__ENTITY_APIEntity>, [
    'aseid',
    'created_at',
    'updated_at'
]>;
...
export type NAMESPACE_APP_INTERACTIONS_TYPES__ENTITYCreateResponse = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<NAMESPACE_TYPES__ENTITY_APIEntity>, [
    'aseid',
    'created_at',
    'updated_at'
]>;
export type NAMESPACE_APP_INTERACTIONS_TYPES__ENTITYUpdateRequest = A_SDK_TYPES__Required<A_SDK_TYPES__DeepPartial<NAMESPACE_TYPES__ENTITY_APIEntity>, [
    'aseid'
]>;
